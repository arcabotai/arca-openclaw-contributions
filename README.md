...
Last refreshed: `2026-07-23T03:48:19+00:00` from the GitHub API.
...
| [#104492](https://github.com/openclaw/openclaw/pull/104492) fix(gateway): preserve channel restart ownership | [@arcabotai](https://github.com/arcabotai) | open; active proof | `2026.7.2` | [`be8ca9eefbf9`](https://github.com/openclaw/openclaw/commit/be8ca9eefbf9317beaa8f7b061310e30a11c011e) | 🦪 silver shellfish | Rebased current patch onto current main and passed 342 focused gateway tests on macOS arm64. Real gateway/channel lifecycle proof remains before re-review. |
